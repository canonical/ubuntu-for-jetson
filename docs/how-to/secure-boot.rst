...
Download the 2023 Microsoft DB from here:
...
Download the 2023 Microsoft KEK from here:
...
Download the 2011 Microsoft DB from here: [![][image1]](https://github.com/microsoft/secureboot_objects/blob/main/PreSignedObjects/DB/Certificates/MicCorUEFCA2011_2011-06-27.der)
...
Download the 2011 Microsoft KEK from here: [![][image2]](https://github.com/microsoft/secureboot_objects/blob/main/PreSignedObjects/KEK/Certificates/MicCorKEKCA2011_2011-06-24.der)
...
For all keys and certificates, we also want to generate the corresponding EFI sig lists and save it in UEFI variables.  For the Microsoft certificates, we first need to convert the Microsoft certificates from DER (Distinguished Encoding Rules) to PEM (Privacy Enhanced Mail) and then to EFI sig list. You can do this by running the following commands:
