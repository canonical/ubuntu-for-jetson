...
Camera
^^^^^^
The following camera tests were conducted on the following Jetson development kits:
...
* Jetson AGX Thor with a development carrier board connected to a LI Dual IMX274 camera module.
